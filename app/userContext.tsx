...
// export type UserRole = "placemaker" | "policymaker" | "dealmaker" | "changemaker" | null;
...
//   // 🔹 Restore session + role on app start
//   useEffect(() => {
...
//             await AsyncStorage.setItem("role", profileData.role);
...
//     setRole(newRole);
//     if (newRole) await AsyncStorage.setItem("role", newRole);
...
//   return (
//     <UserContext.Provider value={{ role, userId, setRole: handleSetRole, setUserId: handleSetUserId }}>
//       {children}
...
//   if (!context) throw new Error("useUserRole must be used within a UserProvider");
//   return context;
// };
